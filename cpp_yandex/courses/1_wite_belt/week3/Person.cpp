...
public:
  ...
  string GetFullNameWithHistory(int year) {
	// получить все имена и фамилии по состо€нию на конец года year
  }
private:
  // приватные пол€
};

¬ отличие от метода GetFullName, метод GetFullNameWithHistory должен вернуть не только последние им€ и фамилию к концу данного года, но ещЄ и все предыдущие имена и фамилии в обратном хронологическом пор€дке. ≈сли текущие факты говор€т о том, что человек два раза подр€д изменил фамилию или им€ на одно и то же, второе изменение при формировании истории нужно игнорировать.

ƒл€ лучшего понимани€ формата см. примеры.
